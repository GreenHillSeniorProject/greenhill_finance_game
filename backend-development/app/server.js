...
/* // Allow requests from the specific domain and port
const corsOptions = {
  origin: 'http://ec2-3-80-87-201.compute-1.amazonaws.com:3001',
...
app.listen(3001, () => {
  console.log("Server successfully running on port 3001")
});
